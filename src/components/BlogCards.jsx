...
const BlogCards = ({ mode }) => {
  const Blogs = [
    { id: 1, title: "Blog 1", description: "This is the first blog post" },
    { id: 2, title: "Blog 2", description: "This is the second blog post" },
    { id: 3, title: "Blog 3", description: "This is the third blog post" },
    { id: 4, title: "Blog 4", description: "This is the fourth blog post" },
  ];
