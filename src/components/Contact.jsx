...
const Contact = ({ mode }) => {
  ...
  contact methods provided. Let’s make your bookmarking experience even better, together.
              ...
              <div className={`mb-3 d-flex align-items-center ${cardBg} p-3 rounded shadow-sm`}>
              ...
              <div className={`d-flex align-items-center ${cardBg} p-3 rounded shadow-sm`}>
            ...
            <div className="col-md-6">
              <div className={`card shadow-sm ${cardBg}`}>
                <div className="card-body">
                  ...
                  <form>
                    <div className="mb-3">
                      <label htmlFor="name" className={`form-label ${textColor}`}>Your Name</label>
                      <input type="text" className="form-control" id="name" placeholder="Enter your name" />
                    </div>
                    <div className="mb-3">
                      <label htmlFor="email" className={`form-label ${textColor}`}>Your Email Address</label>
                      <input type="email" className="form-control" id="email" placeholder="Enter your email" />
                    </div>
                    <div className="mb-3">
                      <label htmlFor="subject" className={`form-label ${textColor}`}>What's this about?</label>
                      <input type="text" className="form-control" id="subject" placeholder="Enter a subject" />
                    </div>
                    <div className="mb-3">
                      <label htmlFor="message" className={`form-label ${textColor}`}>Message Box</label>
